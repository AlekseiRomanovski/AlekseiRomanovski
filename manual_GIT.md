...
Для удаления последнего комита используем команду /git reset HEAD~ ![my foto](logo23.png) 
Для удаления последнего комита и изменений используем команду /git reset --hard HEAD~