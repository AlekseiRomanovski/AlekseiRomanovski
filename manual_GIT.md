...
Состояние комитов и файла до использования  команды /git reset --hard HEAD~   ![my foto](logo26.png)  ![my foto](logo26_1.png)
 ...
 Для создания копии удаленого репозитория используем команду /git clone https://github.com/AlekseiRomanovski/AlekseiRomanovski.git  
 ![my foto](logo28.png)
 Для внесения изменений в удаленый репозиторий используем команду /git push  
 ![my foto](logo29.png)
 Особое внимание уделяем тому в какой папке мы находимся в терминале это можно проверить с помощью команды /ls  
 ![my foto](logo30.png)  
 переходить между папками можно с помощью команды /cd .. (на уровень выше)  
  и /cd .\название папки\ (в нужную нам папку)  
 ![my foto](logo31.png) pullg
 Для внесения изменений в локальный репозиторий из удаленого используем команду /git pull  
 ![my foto](logo32.png)